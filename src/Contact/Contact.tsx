...
const Contact = ({onIsInView}: {onIsInView: () => void}) => {
  ...
  return (
    <motion.div ref={containerRef} initial={{opacity: 0, y: 50}} animate={containerInView ? { opacity: 1, y: 0 } : {}} transition={{duration: 0.8, ease: "easeOut"}} id="Contact"  className="flex flex-col justify-start max-w-[100vw] lg:w-[75%] md:w-[80%] mx-auto sm:gap-10 md:gap-10 gap-10 mt-20 h-[75vh]">
        <div className="flex items-start gap-10">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex items-center  gap-10">
                        <div className="flex flex-col gap-2 w-full">
                            <p>Name</p>
                            <Input type='text' className=' border-zinc-700 bg-zinc-200' />
                        </div>
                        <div className="flex flex-col gap-2 w-full">
                            <p>Email</p>
            ...
            <div className="flex flex-col w-[40%] gap-10">
                <div className="flex items-center gap-3 w-full border-b border-zinc-700 pb-1">
