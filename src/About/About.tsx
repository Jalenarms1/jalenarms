        ...
        <motion.div id="About"  className="flex flex-col w-full lg:w-[75%] md:w-[80%] mx-auto  gap-28 md:gap-0 ">
            <div ref={containerRef}  className="flex flex-col justify-center md:flex-row md:items-center w-full mx-auto gap-20 min-h-screen max-h-screen">
                <div className="flex flex-col items-start md:w-3/4 w-full sm:px-8">
                    ...
                    <p className="text-zinc-900  mt-5 font-light font-app">Hi, I’m Jalen Arms—-a fullstack software developer experienced in building web and mobile applications. My strengths are designing and integrating APIs, building intuitive layouts and managing application state through user interaction.</p>

              <p className="text-zinc-900  mt-5 font-light font-app">I also specialize in data engineering—-designing automated ETL pipelines that gather data from multiple sources, standardize it, and put it in its destination.</p>
