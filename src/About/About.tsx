...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:w-3/4 gap-20 w-full relative text-white pb-60 overflow-y-auto">
        <div id="home" className="flex flex-col md:flex-row w-full mx-auto gap-20">
            <div className="flex flex-col items-start md:w-3/4 w-full px-8">
                ...
                <p className="md:text-4xl lg:text-5xl xl:text-6xl text-3xl font-semibold">Fullstack</p>
            ...
            <div className="w-72 md:mx-0 mx-auto">
                ...
                <motion.img 
                    src="https://firebasestorage.googleapis.com/v0/b/silly-socks-e0923.firebasestorage.app/o/Simulator%20Screenshot%20-%20iPhone%2016%20-%202024-12-28%20at%2009.48.18.png?alt=media&token=862ef46c-2dfd-475b-8cb8-72539a50a982" 
                    alt="ios-img" 
        ...
        <motion.div
            id="about"
            ref={ref}
            className="flex flex-col sm:w-[90%] w-full gap-7 p-8 sm:p-0"
