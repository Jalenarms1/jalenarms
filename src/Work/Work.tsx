...
const Work = ({onIsInView}: {onIsInView: () => void}) => {
  ...
  return (
    <motion.div initial={{opacity: 0, y: 50}} animate={containerInView ? { opacity: 1, y: 0 } : {}} transition={{duration: 0.8, ease: "easeOut"}} id="Work" ref={containerRef}  className="flex flex-col justify-start max-w-[100vw] md:w-[80%] mx-auto sm:gap-10 md:gap-10 gap-10">
